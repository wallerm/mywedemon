...
Page({
    ...
    changeHandle({ detail, currentTarget: { dataset: { idx }, }, }) {
        this.setData({
            [`searchBoxGroup[${idx}].keyword`]: detail.value,
        });
    },
    focusHandle({ currentTarget: { dataset: { idx }, }, }) {
    ...
    cancelHandle({ currentTarget: { dataset: { idx }, }, }) {
        this.setData({
            [`searchBoxGroup[${idx}].actionText`]: '',
        });
    },
    clearHandle({ currentTarget: { dataset: { idx }, }, }) {
        this.setData({
